...
import { SEL, gotoAndWaitForDiff, viewUnified, viewSource, viewDebug, switchView } from './helpers/diff-workbench'
...
test.describe('View switching', () => {
  ...
  test('switches to source view showing projection tables', async ({ page }) => {
  ...
  test('returns to unified view from source', async ({ page }) => {
    await switchView(page, 'source')
